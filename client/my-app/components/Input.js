        ...
        <div>
            <div className={styles.inputCont}>
                <label>
                    ...
                    <input className={styles.inputBox} name="ticker" onChange={handleChange} placeholder="TSLA"/>
                </label>
                <button className={styles.inputButton} onClick={handleSubmit}>Rate!</button>
            </div>
